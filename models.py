...
class User(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    billings = db.relationship('Billing', backref='user', lazy=True, cascade="all, delete")
    feedbacks = db.relationship('Feedback', backref='user', lazy=True, cascade="all, delete")
    service_requests = db.relationship('ServiceRequest', backref='user', lazy=True, cascade="all, delete")
    subscriptions = db.relationship('SubscriptionHistory', backref='user', lazy=True, cascade="all, delete")
    support_tickets = db.relationship('SupportTicket', backref='user', lazy=True, cascade="all, delete")
    transactions = db.relationship('Transactions', backref='user', lazy=True, cascade="all, delete")
    usage_histories = db.relationship('UsageHistory', backref='user', lazy=True, cascade="all, delete")